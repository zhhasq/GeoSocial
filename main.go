...
const (
	...
	ES_URL      = "http://35.243.242.195:9200"
	BUCKET_NAME = "zs-post-images"
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//if image is jpg, p.Face = 0.0 but jason will make as int 0. ES P.Face is changed to int.
	...
	//	if err != nil {
	//		http.Error(w, "Failed to save post to BigTable\n", http.StatusInternalServerError)
	//		fmt.Printf("Failed to save post to Bigtableh %v.\n", err)
	//		return
	//	}
...
func saveToBigTable(p *Post, id string) error {
	...
	bt_client, err := bigtable.NewClient(ctx, "around-722", "around-post")
	if err != nil {
		//	panic(err)
		return err
	}
